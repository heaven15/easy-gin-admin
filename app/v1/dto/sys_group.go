...
type SysGroupInfoReq struct {
	ParentID int64  `json:"parent_id" binding:"omitempty,min=1" label:"父类用户组ID"`
	RealName string `json:"real_name" binding:"required,min=1,max=30" label:"用户组名称"`
