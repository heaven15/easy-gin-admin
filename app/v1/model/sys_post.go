...
// SysPost 系统岗位表
type SysPost struct {
	ID         int64      `gorm:"primary_key;auto_increment;primary_key;unique;comment:岗位ID" json:"id"`
	RealName   string     `gorm:"column:real_name;index:idx_real_name;unique;not null;type:varchar(30);comment:岗位名称" json:"real_name"`
